...
GAME_MESSAGE = "⩹━★⊷━⌞ سورس الفراعنة ⌝━⊶★━⩺\n\n★¦ مرحبا بك عزيزي:\n★¦في قسم العاب الفراعنة \n\n⩹━★⊷━⌞ سورس الفراعنة ⌝━⊶★━⩺"
GAME_BUTTONS = [
    [ 
        InlineKeyboardButton ('★¦العاب 3D', callback_data= 'GAME1'),
        InlineKeyboardButton ('الفراعنة  الفراعنة ', callback_data= 'GAME2'),
        ],[
        InlineKeyboardButton ('⌞ سورس الفراعنة ⌝⚡️', url =f"https://t.me/wasit_go")              
                 ],[
