            ...
            [
                [
                    InlineKeyboardButton(
                        "᳒ᯓ𓆩مطور علي  | 🇮🇶 ˹َّّ ", url=f"https://t.me/co_od"), 
                 ],[
...
@app.on_message(
    command(["علاوي ","مبرمج السورس","ali","علي "])
    & filters.group
    & ~filters.edited
)
...
async def huhh(client: Client, message: Message):
    await message.reply_photo(
        photo=f"https://graph.org/file/9e90986cd4964303776a8.jpg",
        caption=f"""**⩹⊷━⌞  ميوزك الفراعنة  ⌝━━⩺**\nمرحبا بك عزيزي {message.from_user.mention} في قسم الذكاء الاصتناعي الخاص بسورس الفراعنة \nلتتمكن من استخدام اوامر الذكاء الاصتناعي اكتب \n /gpt + السؤال بالاسفل👇\n**⩹━━⌞  ميوزك الفراعنة  ⌝━━⩺**""",
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
...
async def huhh(client: Client, message: Message):
    await message.reply_photo(
        photo=f"https://graph.org/file/9e90986cd4964303776a8.jpg",
        caption=f"""**⩹⊷━⌞  ميوزك الفراعنة  ⌝━━⩺**\nمرحبا بك عزيزي {message.from_user.mention} في قسم تشغيل القرأن الخاص بسورس الفراعنة \nلتتمكن من استخدام اوامر القرأن اكتب \n سورة + اسم السورة بالاسفل👇\n**⩹━━⌞  ميوزك الفراعنة  ⌝━━⩺**""",
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
