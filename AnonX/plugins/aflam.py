"""
        ...
        [InlineKeyboardButton("ᯓ𓆩مطور علي  | 🇮🇶 ˹", callback_data="moslsl " + str(m.from_user.id))],
        [InlineKeyboardButton("⌞ ⩹━⊷⌯ سورس الفراعنة   ⌝⚡", url=f"https://t.me/ co_od")],
"""
...
async def film(c: Client, m: CallbackQuery):
    ...
    keyboard = InlineKeyboardMarkup(inline_keyboard=[
        ...
        [InlineKeyboardButton("ᯓ𓆩مطور علي  | 🇮🇶 ˹", callback_data="aflamAR2 " + str(m.from_user.id))],
        [InlineKeyboardButton("⌞ ⩹━⊷⌯ سورس الفراعنة   ⌝⚡", url=f"https://t.me/ co_od")],
...
async def comedy(c: Client, m: CallbackQuery):
    ...
    keyboard = InlineKeyboardMarkup(inline_keyboard=[
        ...
        [InlineKeyboardButton("ᯓ𓆩مطور علي  | 🇮🇶 ˹", callback_data="film " + str(m.from_user.id))],
        [InlineKeyboardButton("⌞ ⩹━⊷⌯ سورس الفراعنة   ⌝⚡", url=f"https://t.me/ co_od")],
...
async def Xms1(c: Client, m: CallbackQuery):
    ...
    keyboard = InlineKeyboardMarkup(inline_keyboard=[
        ...
        [InlineKeyboardButton("ᯓ𓆩مطور علي  | 🇮🇶 ˹", callback_data="msrahia " + str(m.from_user.id))],
        [InlineKeyboardButton("⌞ ⩹━⊷⌯ سورس الفراعنة   ⌝⚡", url=f"https://t.me/ co_od")],
...
async def Xmsrh1(c: Client, m: CallbackQuery):
    ...
    keyboard = InlineKeyboardMarkup(inline_keyboard=[
        ...
        [InlineKeyboardButton("ᯓ𓆩مطور علي  | 🇮🇶 ˹", callback_data="Xms1 " + str(m.from_user.id))],
        [InlineKeyboardButton("⌞ ⩹━⊷⌯ سورس الفراعنة   ⌝⚡", url=f"https://t.me/ co_od")],
